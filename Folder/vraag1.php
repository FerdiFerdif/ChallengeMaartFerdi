...
<div class="home">
    <div class="mainbackscreen">
        <div class="textblock">
            ...
            <div class="smalltext"> <p id="smalltext">Vraag 1;</p>
            </div>
            ...
            <div class="vraag">
                ...
                $query = "SELECT vraagtekst FROM vraag WHERE vraag_ID = '1'";
                ...
                <form action="postvraag1.php" method="post">
                    <input name="Antwoord1"  value=""/>
