...
<div class="home">
    <div class="mainbackscreen">
        <div class="textblock">
            ...
            <div class="smalltext"> <p id="smalltext">Vraag 4;</p>
            </div>
            ...
            <div class="vraag">
                ...
                $query = "SELECT vraagtekst FROM vraag WHERE vraag_ID = '4'";
                ...
                <form action="postvraag4.php" method="post">
                    <input name="Antwoord4"  value=""/>
