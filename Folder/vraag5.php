...
<div class="home">
    <div class="mainbackscreen">
        <div class="textblock">
            ...
            <div class="smalltext"> <p id="smalltext">Vraag 5;</p>
            </div>
            ...
            <div class="vraag">
                ...
                $query = "SELECT vraagtekst FROM vraag WHERE vraag_ID = '5'";
                ...
                <form action="postvraag5.php" method="post">
                    <input name="Antwoord5"  value=""/>
