...
<div class="home">
    <div class="mainbackscreen">
        <div class="textblock">
            ...
            <div class="smalltext"> <p id="smalltext">Vraag 6;</p>
            </div>
            ...
            <div class="vraag">
                ...
                $query = "SELECT vraagtekst FROM vraag WHERE vraag_ID = '6'";
                ...
                <form action="postvraag6.php" method="post">
                    <input name="Antwoord6"  value=""/>
