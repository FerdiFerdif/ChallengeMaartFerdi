...
<div class="home">
    <div class="mainbackscreen">
        <div class="textblock">
            ...
            <div class="smalltext"> <p id="smalltext">Vraag 2;</p>
            </div>
            ...
            <div class="vraag">
                ...
                $query = "SELECT vraagtekst FROM vraag WHERE vraag_ID = '2'";
                ...
                <form action="postvraag2.php" method="post">
                    <input name="Antwoord2"  value=""/>
